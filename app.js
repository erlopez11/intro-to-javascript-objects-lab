...
game.party.push(pokemon[2], pokemon[61], pokemon[134]);
...
for (let i = 0; i < pokemon.length; i++) {
    if (pokemon[i].starter === true) {
        console.log(`Starter Pokemon: ${pokemon[i].name}`);
    }
}
...
game.partyCount = function () {
    ...
    return `${partyTotal} Pokemon in your party`;
}
...
console.log(game.party.sort(function(a, b){return b.hp - a.hp}));
